...
//todo: 构图说明(比如数组和链表之后接双指针、前缀和等等)

### 个人经验

1. 对于一时半会儿想不出来的题目，可以先放一放，先尝试一下相关类型的简单题目，后面再回来看，先追求广度。
2. 对于自己构思或参考别人的解决，最好选择简单通俗易通的解决，不要过分追求低时间复杂度和底空间复杂度的解决方案。
3. 对于一些复杂的题目解法，建议自己能够通过画图可视化出来，加强理解和记忆。
4. 关联类比现实中的应用场景，做到真正的活学活用。
...
- [堆简要说明](./docs/数据结构篇/堆/brief_introduction.md)
- [题解](./docs/数据结构篇/堆/problems.md)
...
- [滑动窗口简要说明](./docs/算法篇/滑动窗口/brief_introduction.md)
- [题解](./docs/算法篇/滑动窗口/problems.md)

### 前缀和

- [前缀和简要说明](./docs/算法篇/前缀和/brief_introduction.md)
- [题解](./docs/算法篇/前缀和/problems.md)
